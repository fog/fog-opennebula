            ...
            class Real
                ...
                def list_vms(filter = {})
                    ...
                    if filter[:id].nil?
                        ...
                        vmpool.info_search(:start_id => filter[:id], :end_id => filter[:id],
                                           :extended => true)
                    end
                    ...
                    vmpool.each do |vm|
                        ...
                        unless one['VM']['TEMPLATE'].nil?
                            data['cpu'] =
                                one['VM']['TEMPLATE']['CPU'] unless one['VM']['TEMPLATE']['CPU'].nil?
                            data['vcpu']   =
                                one['VM']['TEMPLATE']['VCPU'] unless one['VM']['TEMPLATE']['VCPU'].nil?
                            data['memory'] =
                                one['VM']['TEMPLATE']['MEMORY'] unless one['VM']['TEMPLATE']['MEMORY'].nil?
                            unless one['VM']['TEMPLATE']['NIC'].nil?
                                if one['VM']['TEMPLATE']['NIC'].is_a?(Array)
                                    ...
                                    data['ip'] =
                                        one['VM']['TEMPLATE']['NIC']['IP'] unless one['VM']['TEMPLATE']['NIC']['IP'].nil?
                                    data['mac'] =
                                        one['VM']['TEMPLATE']['NIC']['MAC'] unless one['VM']['TEMPLATE']['NIC']['MAC'].nil?
                                end
                            end
                        end
